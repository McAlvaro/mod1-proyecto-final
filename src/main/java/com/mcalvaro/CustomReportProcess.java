...
public class CustomReportProcess extends BaseReportProcess {
    ...
    public CustomReportProcess(Processor processor, ReportFactory reportFactory, Deliverable delivery,
